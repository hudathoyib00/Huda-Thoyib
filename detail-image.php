    ...
    <div class="section">
        <div class="container">
            <form action="galeri.php">
                <input type="text" name="search" class="input-control" placeholder="Cari Foto" value="<?php echo $_GET['search'] ?>" />
                <input type="hidden" name="kat"  value="<?php echo $_GET['search'] ?>" />
                <input type="sumbit" name="cari" value="Cari Foto" class="btn" />
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-2">
                    ...
                    <h4>Nama User : <?php echo $p->date_created ?></h4>
                    Deskripsi :<br/>
