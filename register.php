    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                ...
                <input type="text" name="nama" placeholder="Name User" class="input-control" required>
                <input type="text" name="user" placeholder="Username" class="input-control" required>
                <input type="text" name="pass" placeholder="Password" class="input-control" required>
                <input type="text" name="tlp" placeholder="Nomer Telpon" class="input-control" required>
